...
# encoding=utf-8
#__author__ ='zx'
#__time__ ='2017-10-2817:28'
'''
AddDataInfo_testcode
'''
import unittest
...
from base import businessCommon

add_xls = common.get_xls("LTClogin.xls", "LTCadd")
localReadConfig = readConfig.ReadConfig()
configHttp = ConfigHttp.ConfigHttp()


@paramunittest.parametrized(*add_xls)
class LTCadd(unittest.TestCase):
    def setParameters(self, case_name, method, token, CommandCode, Marker, TransferData, result, ExecuteResult,
                      ErrorInfo, ErrorCode, ResultInfo):
    ...
    def description(self):
        ...
        :return:
        """
        return (self.case_name+'测试添加意见反馈的接口')
    ...
    def testAdd(self):
        ...
        """
        # set url
        self.url = common.get_url_from_xml('LTCadd')
